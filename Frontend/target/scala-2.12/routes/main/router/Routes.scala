...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """nation-switch-app""", """controllers.HomeController.locationRequestForm()"""),
  ...
  private[this] lazy val controllers_HomeController_locationRequestForm14_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("nation-switch-app")))
  )
